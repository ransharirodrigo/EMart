...
$query .= " ORDER BY `top_selling_items`.`qty` LIMIT 4";
        ...
        <div class="col-8 offset-2  col-md-4 offset-md-0 col-lg-3 mt-2">
            <a href="#" class="text-decoration-none text-reset">
                <div class="card">
                    ...
                    ?>
                        <img src="<?php echo $best_selling_items_array["path"] ?>" class="card-img-top" alt="...">
                    <?php
                    } else {
                    ?>
                        <img src="assets/img/product_images/default_product_icon.svg" class="card-img-top" alt="...">
                    <?php
                    }
                    ?>
